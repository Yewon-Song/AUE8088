...
def parse_opt():
    ...
    parser.add_argument("--textListFile",   type=str, default='/home/yewon/project/AUE8088/datasets/kaist-rgbt copy/train-all-04.txt',         help="Text file containing image file names (e.g., train-all-04.txt)")
    parser.add_argument("--xmlAnnDir",      type=str, default='/home/yewon/project/AUE8088/datasets/kaist-rgbt copy/train/labels-xml',   help="XML annotation directory")
    parser.add_argument("--jsonAnnFile",    type=str, default='/home/yewon/project/AUE8088/utils/eval/KAIST_annotation.json',           help="Output json filename")
